    ...
    public static class InstructionEmitterRegistry
    {
        public static Dictionary<OpCode, Interfaces.IEmitter> Create()
        {
            return new Dictionary<OpCode, Interfaces.IEmitter>
            {
                ...
                // IL mnemonic: blt = branch if less than, S = short, used for conditional branching
                { OpCodes.Blt_S,    new ILOpCodes.Blt_S_Emitter() },
                // IL mnemonic: conv = convert, I = integer, 4 bytes
                ...
                // IL mnemonic: Stind = store indirect, I = integer, 4-8 bytes
                ...
                // IL mnemonic: ldloc = load local variable, loc = local variable, 0-3 local variables
